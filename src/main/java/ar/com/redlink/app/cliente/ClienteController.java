...
public class ClienteController {
	...
	@GetMapping("")
	public Page<Cliente> get(@RequestParam(value = "nombre", required = false) String nombre, Pageable page){
	...
	@Transactional
	@DeleteMapping("")
	public void delete(@RequestBody Cliente cliente) throws InexistenciaException {
